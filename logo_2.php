...
<div class="row" style="background-color: white">
     <div onclick="window.location.href='teacher.php'" class="col-lg-1">
            <img src="logo.png" height="70" width="90" style="margin-left:1px ; margin-bottom:1px ; margin-top:1px">
     </div>
     <div onclick="window.location.href='teacher.php'" class="col-lg-10" style="font-family:'Times New Roman', Times, serif ; font-size:36px ; margin-top:8px  ; color:#666">
          LEARNING AID
     </div>
     <form method="post">
